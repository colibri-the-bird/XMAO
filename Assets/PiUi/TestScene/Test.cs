...
public class Test : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (piUi.OverAMenu())
        {
            UnityEngine.Debug.Log("You are over a menu");
            ...
            UnityEngine.Debug.Log("You are not over a menu");
    ...
    public void TestFunction()
    {
        ...
        UnityEngine.Debug.Log("You Clicked me!");
    }

    public void OnHoverEnter()
    {
        UnityEngine.Debug.Log("Hey get off of me!");
    }
    public void OnHoverExit()
    {
        UnityEngine.Debug.Log("That's right and dont come back!");
    }
}
